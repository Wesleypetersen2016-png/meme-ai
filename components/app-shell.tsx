...
const nav = [
  ...
  { href: "/portfolio", label: "My positions", shortLabel: "Positions", icon: "◒" },
    ...
    <div className="min-h-screen md:grid md:grid-cols-[224px_1fr]">
      ...
      <div className="md:col-start-2">
        <header className="sticky top-0 z-30 flex h-16 items-center justify-between border-b border-[#222622] bg-[#0a0c0b]/90 px-4 backdrop-blur-xl md:h-20 md:px-8">
          ...
          <button onClick={() => setSearchOpen(!searchOpen)} className="pill hidden w-80 items-center gap-3 px-4 py-2.5 text-left text-xs text-[#757c75] md:flex"><span className="text-base">⌕</span> Research a token…<kbd className="mono ml-auto text-[9px]">⌘ K</kbd></button>
